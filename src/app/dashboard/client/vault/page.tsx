...
export default function ClientVaultPage() {
  ...
  // Files must be scoped to a session; upload into the nearest scheduled
  // session, falling back to the most recent one.
    ...
    <div className="w-full relative min-h-screen flex flex-col pt-6 pb-24">
      ...
      >
        ...
        <p className="text-sm text-[var(--text-muted)] font-inter mb-6">
          {targetSessionId ? "Drag and drop files here or click to browse." : "Book a session before uploading files."}
        </p>
