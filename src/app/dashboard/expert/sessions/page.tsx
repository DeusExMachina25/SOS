...
import { Calendar as CalIcon, Video, Search, CalendarDays } from "lucide-react";
...
export default function ExpertSessionsPage() {
  ...
  const filteredSessions = mySessions.filter(s => activeFilter === "all" || s.status === activeFilter);
