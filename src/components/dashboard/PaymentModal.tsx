        ...
        >
          ...
          {mode === "choose" ? (
            <>
              ...
              {error && (
                <p className="text-sm text-[var(--color-orange)] font-mono-sos mb-6 text-center">{error}</p>
              )}
              ...
              <div className="space-y-4">
                ...
                <div className="p-6 bg-[var(--bg-surface)] border border-[var(--border-strong)] rounded-2xl">
                  <div className="flex items-center gap-3 mb-4">
                    <Smartphone size={20} className="text-[var(--color-green)]" />
                  ...
                  {expertUpiId ? (
                    <>
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <button
                          onClick={handleCopy}
                          className="w-11 h-11 shrink-0 rounded-xl bg-[var(--bg-base)] border border-[var(--border)] flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--color-green)] hover:border-[var(--color-green)]/50 transition-all"
                          title="Copy UPI ID"
                        >
                          {copied ? <Check size={16} className="text-[var(--color-green)]" /> : <Copy size={16} />}
                        </button>
                      </div>
                      <button
                        onClick={handleUpiSent}
                        disabled={loading !== null}
                        className="w-full py-3 rounded-xl bg-[var(--color-green)]/10 border border-[var(--color-green)]/40 text-[var(--color-green)] text-sm font-bold hover:bg-[var(--color-green)]/20 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                      >
